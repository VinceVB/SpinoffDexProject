...
# List of all Mystery dungeon accessories
md_accessories = [
[[['No-Stick Cap'], ['くっつかずきん / No-Stick Hood'], ['1500 '], ['550 '], ['Prevents Sticky Trap from working.'], [[['Fiery Field, Lightning Field, Northwind Field, Buried Relic, Southern Cavern, Wyvern Hill, Darknight Relic, Joyous Tower, Purity Forest'], ['Kecleon Shop (Purity Forest)']]], ["A hold item that prevents the Pokémon's items from becoming sticky and gummed up."]]], [[['Pecha Scarf'], ['モモンスカーフ / Momon Scarf'], ['1200 '], ['500'], ['Prevents poisoning.'], [[['Pokemon Square shop, After Great Canyon'], ['Lapis Cave, Frosty Forest (First part only), Mt. Freeze (First part only), Magma Cavern (First part only), Sky Tower, Stormy Sea, Northern Range, Pitfall Valley, Buried Relic, Wish Cave, Desert Region, Darknight Relic, Grand Sea, Joyous Tower, Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Frosty Forest, Magma Cavern, Northern Range, Pitfall Valley, Wish Cave, Joyous Tower, Purity Forest, Remains Island)'], ['Reward for saving Diglett']]], ['A hold item that prevents the Pokémon from being poisoned or badly poisoned.']]], [[['Persim Band'], ['キーのハチマキ / Kī Headband'], ['1500 '], ['750'], ['Prevents confusion.'], [[['Pokemon Square shop, After Great Canyon'], ['Magma Cavern (First part only), Sky Tower, Stormy Sea, Northern Range, Pitfall Valley, Buried Relic, Wish Cave, Wyvern Hill, Solar Cave, Darknight Relic, Joyous Tower, Purity Forest'], ['Kecleon Shop (Magma Cavern, Northern Range, Pitfall Valley, Wish Cave, Wyvern Hill, Joyous Tower, Purity Forest, Oddity Cave)'], ['Job rewards (D-★)']]], ['A hold item that prevents the Pokémon from becoming Confused.']]], [[['Weather Band'], ['ノーてんバンダナ / No-Weather Bandana'], ['4000 '], ['1500'], ["Pokémon isn't affected by the weather."], [[['Pokemon Square shop, After Sky Tower'], ['Buried Relic, Wish Cave, Solar Cave, Darknight Relic, Purity Forest'], ['Kecleon Shop (Wyvern Hill, Purity Forest, Oddity Cave)'], ['Job rewards (C-★)']]], ['A hold item that prevents the Pokémon from feeling the effects of the weather.']]], [[['Defense Scarf'], ['ぼうぎょスカーフ / Defense Scarf'], ['3000'], ['1350'], ['Boosts Defense.'], [[['Stormy Sea, Silver Trench, Fiery Field, Lightning Field, Northwind Field, Northern Range, Pitfall Valley, Buried Relic, Wish Cave, Southern Cavern, Wyvern Hill, Solar Cave, Darknight Relic, Purity Forest, Oddity Cave, Remains Island, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Wish Cave, Wyvern Hill, Joyous Tower, Purity Forest, Oddity Cave)'], ['Buried items (Far-off Sea)'], ['Job rewards (A-★)']]], ["A hold item that boosts the Pokémon's Defense."]]], [[['Detect Band'], ['みきりハチマキ / All-Seeing Headband'], ['5000 '], ['1500'], ['Boosts Evasion.'], [[['Sky Tower, Stormy Sea, Silver Trench, Buried Relic, Wish Cave, Solar Cave, Darknight Relic, Grand Sea, Joyous Tower, Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Purity Forest 90-98F)'], ['Buried items (Far-off Sea)']]], ["A hold item that boosts the Pokémon's Evasion."]]], [[['Munch Belt'], ['ゴンベのハラマキ / Gonbe Stomach Band'], ['4000 '], ['1500'], ['Boosts Attack and Special Attack by 8 each, but makes the Belly empty faster. After obtaining the belt in Red Rescue Team and Blue Rescue Team, a message in the Adventure Log will read, "Spotted Munchlax".'], [[['Give food to Munchlax, which appears at one point in Pokémon Square'], ['Wish Cave, Joyous Tower, Purity Forest'], ['Kecleon Shop (Wish Cave, Joyous Tower, Purity Forest)'], ['Buried items (Far-off Sea)']]], ["A hold item that slightly boosts the Pokémon's Attack and Special Attack. However, it also makes the Pokémon's Belly go down faster."]]], [[['Power Band'], ['パワーバンダナ / Power Bandana'], ['500 '], ['250'], ['Boosts Attack.'], [[['Pokemon Square shop, After Great Canyon'], ['Silent Chasm, Mt. Thunder (First part only), Great Canyon, Lapis Cave, Mt. Blaze (First part only), Frosty Forest (First part only), Mt. Freeze (First part only), Magma Cavern (First part only), Sky Tower, Stormy Sea, Silver Trench, Northern Range, Pitfall Valley, Buried Relic, Wish Cave, Desert Region, Darknight Relic, Grand Sea, Joyous Tower, Far-off Sea, Purity Forest, Oddity Cave, Remains Island, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Frosty Forest, Magma Cavern, Northern Range, Pitfall Valley, Wish Cave, Joyous Tower, Purity Forest, Remains Island)'], ['Job rewards (D-★)']]], ["A hold item that boosts the Pokémon's Attack."]]], [[['Special Band'], ['スペシャルリボン / Special Ribbon'], ['5000'], ['1500 '], ['Boosts Special Attack.'], [[['Pokémon Square, After Sky Tower'], ['Silent Chasm, Mt. Thunder (First part only), Great Canyon, Mt. Blaze (First part only), Frosty Forest (First part only), Mt. Freeze (First part only), Magma Cavern (First part only), Sky Tower, Fiery Field, Lightning Field, Northwind Field, Buried Relic, Wish Cave, Southern Cavern, Wyvern Hill, Darknight Relic, Joyous Tower, Purity Forest, Oddity Cave, Remains Island'], ['Kecleon Shop (Purity Forest)'], ['Buried items (Far-off Sea)'], ['Job rewards (D-★)']]], ["A hold item that boosts the Pokémon's Special Attack."]]], [[['Twist Band'], ['ねじりハチマキ / Twist Headband'], ['1200 '], ['400 '], ['Prevents Attack and Special Attack lowering.'], [[['Stormy Sea, Silver Trench, Buried Relic, Wish Cave, Solar Cave, Darknight Relic, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Wish Cave, Wyvern Hill, Joyous Tower, Purity Forest, Oddity Cave)']]], ["A hold item that prevents the Pokémon's Attack and Special Attack from going down."]]], [[['Zinc Band'], ['キトサンバンダナ / Chitosan Bandana'], ['5000'], ['1500'], ['Boosts Special Defense.'], [[['Fiery Field, Lightning Field, Northwind Field, Buried Relic, Wish Cave, Southern Cavern, Wyvern Hill, Oddity Cave, Remains Island'], ['Kecleon Shop (Wyvern Hill, Oddity Cave)'], ['Buried items (Far-off Sea)'], ['Job rewards (D-★)']]], ["A hold item that boosts the Pokémon's Special Defense."]]], [[['Bounce Band'], ['おはじきリボン / Counter Ribbon'], ['3500 '], ['1500'], ['Item thrown at Pokémon will bounce off in the direction it came from.'], [[['Fiery Field, Lightning Field, Northwind Field, Buried Relic, Wish Cave, Southern Cavern, Wyvern Hill, Darknight Relic, Grand Sea, Far-off Sea, Purity Forest'], ['Kecleon Shop (Purity Forest)']]], ['A hold item that makes thrown items bounce off the Pokémon.']]], [[['Curve Band'], ['カーブバンダナ / Curve Bandana'], ['50 '], ['25'], ["Thrown items bounce of the walls. Doesn't work if user has Pierce status, or is throwing a Geo Pebble or Gravelerock."], [[['Darknight Relic, Grand Sea, Joyous Tower, Far-off Sea, Purity Forest'], ['Kecleon Shop (Purity Forest)'], ['Buried items (Far-off Sea)']]], ["A hold item that makes thrown items bounce off walls and fly sideways. It has no effect if the Pokémon's status is Pierce or if a rock is thrown."]]], [[['Diet Ribbon'], ['はらぺこリボン / Hunger Ribbon'], ['50 '], ['25'], ["If held by Leader, makes Belly empty faster. If held by anyone else, it empties the holder's Belly, inflicting the Hungry Pal status, and prevents the holder's Belly from being filled by eating."], [[['Fiery Field, Lightning Field, Northwind Field, Buried Relic, Wish Cave, Southern Cavern, Wyvern Hill, Darknight Relic, Grand Sea, Joyous Tower, Far-off Sea, Purity Forest'], ['Kecleon Shop (Purity Forest)']]], ["A hold item that changes the Pokémon's status to Hungry Pal and prevents its Belly from filling. If the team leader is holding it, its Belly will go down faster."]]], [[['Dodge Scarf'], ['みかわしスカーフ / Glance Scarf'], ['5000 '], ['2500'], ['Pokémon always dodges throwing items.'], [[['Purity Forest'], ['Kecleon Shop (Wyvern Hill, Joyous Tower, Oddity Cave)'], ['Buried items (Far-off Sea)'], ['Job rewards (A-★)']]], ['A hold item that prevents any thrown item from hitting the Pokémon.']]], [[['Gold Ribbon'], ['きんのリボン / Gold Ribbon'], ['3000'], ['2000'], ['Does nothing, but can be sold for big money.'], [[['Mt. Thunder (First part only), Lapis Cave, Magma Cavern (First part only), Sky Tower (First part only), Stormy Sea, Northern Range, Pitfall Valley, Desert Region, Grand Sea, Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Magma Cavern, Northern Range, Pitfall Valley, Wish Cave, Remains Island)'], ['Buried items (Mt. Blaze Peak, Frosty Grotto, Mt. Freeze Peak, Magma Cavern Pit, Lightning Field, Northwind Field)']]], ['An item that has no effect even if it is held by a Pokémon. It can be sold for a good price.']]], [[['Heal Ribbon'], ['かいふくリボン / Heal Ribbon'], ['1100 '], ['350 '], ['Speeds up HP regeneration and Belly consumption. When given to a Pokémon other than the leader, it eventually stands still with the "Immobilized by hunger" status condition.'], [[['Pokemon Square shop, After Great Canyon'], ['Mt. Freeze (First part only), Magma Cavern (First part only), Sky Tower, Stormy Sea, Silver Trench, Northern Range, Pitfall Valley, Buried Relic, Wish Cave, Desert Region, Solar Cave, Darknight Relic, Grand Sea, Joyous Tower, Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Magma Cavern, Northern Range, Pitfall Valley, Wish Cave, Wyvern Hill, Joyous Tower, Purity Forest, Oddity Cave, Remains Island)'], ['Job rewards (C-★)']]], ["A hold item that speeds up the Pokémon's natural HP regeneration. The Pokémon's Belly will go down faster, however."]]], [[['Joy Ribbon'], ['しあわせリボン / Joy Ribbon'], ['5000 '], ['2000'], ['Earns the holder Exp. Points equal to the damage it takes, each time it takes damage of any sort. '], [[['Sky Tower, summit only, Fiery Field, Lightning Field, Northwind Field, Northern Range, Pitfall Valley, Southern Cavern, Darknight Relic, Grand Sea, Joyous Tower, Far-off Sea, Purity Forest'], ['Kecleon Shop (Magma Cavern, Northern Range, Pitfall Valley, Wish Cave, Joyous Tower, Remains Island)']]], ['A hold item that earns the Pokémon Exp. Points when taking damage.']]], [[['Mobile Scarf'], ['つうかスカーフ / Passing Scarf'], ['1000 '], ['300 '], ['Pokémon can walk on anything. Its Belly will go down by 5 every time it walks through a wall tile. If player takes it down while in wall, Pokémon will randomly warp out of wall.'], [[['Reward from Gengar after escorting him through Murky Cave'], ['Buried Relic, Wish Cave, Wyvern Hill'], ['Kecleon Shop (Purity Forest 90-98F)'], ['Buried items (Far-off Sea)']]], ["A hold item that enables the Pokémon to move and attack through walls and on magma, etc. The Pokémon's Belly will go down faster while traveling through walls, however."]]], [[['Pass Scarf'], ['あしらいスカーフ / Reception Scarf'], ['5000 '], ['1500'], ["Passes on attacks to a Pokémon next to it and drains the holder's Belly each time."], [[['Pokemon Square shop, After Sky Tower'], ['Stormy Sea, Silver Trench, Buried Relic, Wish Cave, Wyvern Hill, Solar Cave, Darknight Relic, Joyous Tower, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Wyvern Hill, Purity Forest, Oddity Cave)']]], ["A hold item that can enable the Pokémon to pass off the effects of attacks and certain kind of hostile moves to a Pokémon next to it. However, it also makes the Pokémon's Belly go down."]]], [[['Patsy Band'], ['ねらわれハチマキ / Aim Headband'], ['50 '], ['25'], ['Moves targeting user have their base critical hit ratio increased by flat 30%'], [[['Stormy Sea, Silver Trench, Buried Relic, Wish Cave, Solar Cave, Darknight Relic, Grand Sea, Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Wyvern Hill, Purity Forest)</table><tr><td class="roundy" colspan="5" style="vertical-align:top; border: 2px solid #7C4B2D; background: #FFF"><table class="roundy" style="vertical-align:top; background: #FFF; width: 100%; border-collapse:collapse"><tr style="vertical-align:top; text-align:center"><td colspan="2"> <b>Description</b><tr><td style="border-top: 1px solid #7C4B2D" width="40px"> <b>Pokémon Mystery Dungeon: Red Rescue Team and Blue Rescue Team</b></td>A hold item that increases the user\'s chance of taking critical hits from enemy moves or attacks.<tr><td style="border-top: 1px solid #7C4B2D" width="40px"> <b>Pokémon Mystery Dungeon: Explorers of Time and Explorers of DarknessPokémon Mystery Dungeon: Explorers of Sky</b></td>A held item that increases the Pokémon\'s chances of taking critical hits from enemy moves and attacks.</table></table>']]], ["A hold item that increases the user's chance of taking critical hits from enemy moves or attacks."]]], [[['Pierce Band'], ['かんつうバンダナ / Pierce Bandana'], ['1600 '], ['600 '], ["A thrown item will go through walls and Pokémon. Item can't be recovered. Doesn't work on thrown rocks (Geo Pebble and Gravelerock)."], [[['Fiery Field, Lightning Field, Northwind Field, Buried Relic, Wish Cave, Southern Cavern, Wyvern Hill, Darknight Relic, Joyous Tower']]], ["A hold item that makes the Pokémon's thrown items pierce other Pokémon, walls and obstacles without ever stopping."]]], [[['Plain Ribbon'], ['ただのリボン / Just A Ribbon'], ['50 '], ['25'], ['Does absolutely nothing.'], [[['Darknight Relic, Grand Sea, Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait, Pokémon Mystery Dungeon: Red Rescue Team and Blue Rescue Team, Pokémon Mystery Dungeon: Explorers of Time and Explorers of Darkness, Pokémon Mystery Dungeon: Explorers of Sky']]], ['An item that has no effect even if it is held by a Pokémon.']]], [[['Racket Band'], ['ばくおんハチマキ / Explosion Headband'], ['3000 '], ['1300'], ['Pokémon will wake up every hostile Pokémon in the room it enters, but only if they were sleeping at the start of the floor.'], [[['Magma Cavern, Sky Tower, Fiery Field, Lightning Field, Northwind Field, Northern Range, Pitfall Valley, Buried Relic, Wish Cave, Southern Cavern, Wyvern Hill, Darknight Relic, Grand Sea, Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Magma Cavern, Northern Range, Pitfall Valley, Wish Cave, Joyous Tower, Purity Forest, Remains Island)</table><tr><td class="roundy" colspan="5" style="vertical-align:top; border: 2px solid #7C4B2D; background: #FFF"><table class="roundy" style="vertical-align:top; background: #FFF; width: 100%; border-collapse:collapse"><tr style="vertical-align:top; text-align:center"><td colspan="2"> <b>Description</b><tr><td style="border-top: 1px solid #7C4B2D" width="40px"> <b>Pokémon Mystery Dungeon: Red Rescue Team and Blue Rescue Team</b></td>A hold item that helps awaken hostile sleeping Pokémon. It only works against Pokémon that were asleep from the start.<tr><td style="border-top: 1px solid #7C4B2D" width="40px"> <b>Pokémon Mystery Dungeon: Explorers of Time and Explorers of DarknessPokémon Mystery Dungeon: Explorers of Sky</b></td>A held item that helps awaken sleeping Pokémon enemies. It only works on Pokémon that were asleep from the start.</table></table>']]], ['A hold item that helps awaken hostile sleeping Pokémon. It only works against Pokémon that were asleep from the start.']]], [[['Sneak Scarf'], ['こっそりスカーフ / Stealth Scarf'], ['2500 '], ['1000'], ["Pokémon won't wake up a sleeping Pokémon next to it, but only if it was sleeping at the start of the floor."], [[['Fiery Field, Lightning Field, Northwind Field, Buried Relic, Wish Cave, Southern Cavern, Wyvern Hill, Darknight Relic, Grand Sea, Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Purity Forest)']]], ['A hold item that prevents the Pokémon from awakening sleeping foes. It only works against foes that are asleep to begin with.']]], [[['Stamina Band'], ['スタミナリボン / Stamina Ribbon'], ['3200 '], ['1400'], ['Slows down Belly consumption.'], [[['Pokemon Square shop, After Great Canyon but before Sky Tower'], ['Lapis Cave, Frosty Forest (First part only), Mt. Freeze (First part only), Magma Cavern (First part only), Sky Tower, Stormy Sea, Silver Trench, Northern Range, Pitfall Valley, Buried Relic, Wish Cave, Desert Region, Solar Cave, Darknight Relic, Grand Sea, Joyous Tower, Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Magma Cavern, Northern Range, Pitfall Valley, Wish Cave, Wyvern Hill, Purity Forest, Oddity Cave, Remains Island)'], ['Buried items (Far-off Sea)']]], ["A hold item that slows how quickly the Pokémon's Belly goes down."]]], [[['Tight Belt'], ['きついハラマキ / Tight Stomach Band'], ['5000 '], ['1000'], ['Prevents Belly from emptying, unless Pokémon walks through wall or uses a linked move, in which case, the Belly decreases by one.'], [[['Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Purity Forest 90-98F)'], ['Buried items (Far-off Sea)']]], ["A hold item that prevents the Pokémon's Belly from going down each turn."]]], [[['Trap Scarf'], ['わなぬけスカーフ / Trap-Fading Scarf'], ['5000 '], ['1500'], ['Prevents from setting off traps by Pokémon by stepping on them.'], [[['Kecleon Shop (Purity Forest 90-98F)'], ['Buried items (Far-off Sea)']]], ['A hold item that prevents traps from going off if they are stepped on by the Pokémon.']]], [[['Warp Scarf'], ['ワープスカーフ / Warp Scarf'], ['50 '], ['25'], ['Randomly warps holder every 3-5 steps.'], [[['Pokemon Square shop, After Sky Tower'], ['Magma Cavern, Sky Tower, Stormy Sea, Silver Trench, Northern Range, Pitfall Valley, Buried Relic, Wish Cave, Darknight Relic, Grand Sea, Joyous Tower, Far-off Sea, Purity Forest, Marvelous Sea, Fantasy Strait'], ['Kecleon Shop (Magma Cavern, Northern Range, Pitfall Valley, Wish Cave, Purity Forest, Remains Island)']]], ['A hold item that occasionally warps the Pokémon to another place on the same floor.']]]
]
